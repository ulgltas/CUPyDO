...
def main(battery, nogui): # NB, the two arguments 'battery' and 'nogui' are specific to PFEM problems involving FSI!
    ...
    csd_file = 'waterColoumnWithElasticGate_gate_Mtf_rho_1100_fine_E_9_8e6_EAS'
    nDim = 2
    tollFSI = 1e-6
    dt = 0.001
    tTot = 0.5
    ...
    algorithm = FSICoupler.AlgortihmIQN_ILS(manager, fluidSolver, solidSolver, interpolator, criterion, nFSIIterMax, dt, tTot, 0, omegaMax, 0, False, comm)

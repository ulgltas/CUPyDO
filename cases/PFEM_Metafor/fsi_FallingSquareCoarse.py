...
def getParameters(_p):
    ...
    p['testName'] = fileName
    p['cfd_file'] = 'FallingSquareCoarse_Fluid_Pfem'
    p['csd_file'] = 'FallingSquareCoarse_Square_Mtf'
    p.update(_p)
    return p
...
def main(_p, nogui): # NB, the argument 'nogui' is specific to PFEM only!
    ...
    fluidSolver = cupydoInterfaces.PfemInterface.PfemSolver(cfd_file, 3, p['dt'])

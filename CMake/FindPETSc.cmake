...
FIND_PATH(PETSC_DIR include/petsc.h HINTS ENV PETSC_DIR PATHS /usr/local/lib/python2.7/dist-packages/petsc /opt/local/lib/petsc $ENV{HOME}/petsc)

FIND_LIBRARY(PETSC_LIBRARIES NAMES petsc PATHS ${PETSC_DIR}/lib)

INCLUDE(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(PETSc DEFAULT_MSG PETSC_DIR PETSC_LIBRARIES)

IF(PETSC_FOUND)
  SET(PETSC_INCLUDE_PATH "${PETSC_DIR}/include" CACHE PATH "" FORCE)

...
def getMetafor(p={}):
    ...
    f = os.path.join(os.path.dirname(__file__), "waterColoumnFallWithFlexibleObstacle_Mtf_Pfem_medium.msh")
    ...
    materlawset(1).put(IH_SIGEL, 5.0e4)
    materlawset(1).put(IH_H,     20000.)

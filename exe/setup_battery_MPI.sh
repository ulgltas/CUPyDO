...
# Some library locations

export PETSC_INC=/usr/include/petsc
...
CUPyDO(){
    ...
    cmake -Wno-dev -DCMAKE_BUILD_TYPE=Release -DWITH_MPI=1 \
    -DCMAKE_INSTALL_PREFIX=bin -DPETSC_INCLUDE_PATH=${PETSC_INC} ..
    make -j8 install
}

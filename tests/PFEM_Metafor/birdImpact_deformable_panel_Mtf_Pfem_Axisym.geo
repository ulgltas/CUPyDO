...
Physical Line(14) = {2, 4};       //Clamping + Axis of symmetry for the panel
Physical Line(15) = {8};	  //Axis of symmetry for the bird
Physical Line(16) = {5, 6, 7}; 	  //Free surface
Physical Surface(17) = {10};      //Bird
Physical Surface(18) = {12};      //Panel

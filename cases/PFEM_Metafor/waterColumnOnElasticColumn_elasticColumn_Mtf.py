...
def params(q={}):
    ...
    """
    p={}
    p['tolNR']      = 1.0e-10        # Newton-Raphson tolerance
    p['tend']       = 0.5            # final time
    p['dtmax']      = 0.005          # max time step
    p['bndno']      = 14            # interface boundary number
...
def getMetafor(p={}):
    ...
    if 1:
        ...
        #tsm.setNextTime(1.1, 1, 1.0)
        # tsm.setMaxNbOfItInAdaptOfTimeStep(21)

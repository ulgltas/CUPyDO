...
def params(q={}):
    ...
    p['bndno']      = 5            # interface boundary number
...
def getMetafor(p={}):
    ...
    vmgr.add(2, DbNodalValueExtractor(groupset(7), Field1D(TY,RE), SortByDist0(0.,-6.19985,0.), 2)) #Vertical displacement of the center (upper skin) of the panel

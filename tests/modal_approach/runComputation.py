...
def main():
    ...
    csd_file = 'surface_wing_modes_modal_approach.csv'
    ...
    # --- Initialize modal approach --- #
    solidSolver = None
    if myid == rootProcess:
        import ModalApproach
        solidSolver = ModalApproach.modalInterpreter(csd_file, initialModalDisp, initialModalVel, modalMass, modalDamping, modalStiffness)

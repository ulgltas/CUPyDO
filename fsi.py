...
class Manager:
  ...
  def __init__(self, FluidSolver, SolidSolver, nDim, computationType, MPIComm=None):
    ...
    print "self.FluidIndexing = ", self.fluidIndexing
    print "self.SolidIndexing = ", self.solidIndexing
    print "self.FluidHaloNodeList = ", self.fluidHaloNodesList
    print "self.SolidHaloNodeList = ", self.solidHaloNodesList
...
class MatchingMeshesInterpolator(InterfaceInterpolator):
  ...
  def __init__(self, Manager, FluidSolver, SolidSolver, MPIComm = None):
    ...
    print "nf = ", self.nf
    print "ns = ", self.ns
    print "nf_loc = ", self.nf_loc
    print "ns_loc = ", self.ns_loc
  ...
  def fillMatrix(self, solidInterfaceBuffRcv_X, solidInterfaceBuffRcv_Y, solidInterfaceBuffRcv_Z, iProc):
    ...
    for iVertex in range(self.nf_loc):
      ...
      print "iGlobalVertexFluid = ", iGlobalVertexFluid
      print "jVertex = ", jVertex
      print "jGlobalVertexSolid = ", jGlobalVertexSolid
      print "\n"

...
def test(nogui, res, tol):
    ...
    tests = CTests()
    tests.add(CTest('Lift coefficient', resultA[2], 0.2, 1e-1, False)) # rel. tol. of 10%, dummy value
    tests.add(CTest('TE. vertical displacement', resultS[2], 0.035, 1e-1, False)) # rel. tol. of 10%, dummy value
    tests.run()

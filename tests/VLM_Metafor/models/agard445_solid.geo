...
line_ids_1[] = Symmetry {0, 1, 0, 0} {
  Duplicata { Line{1,6,7,12,101,111}; }
};
line_ids_2[] = Symmetry {0, 1, 0, 0} {
  Duplicata {  Line{2,5,8,11,102,112}; }
};
line_ids_3[] = Symmetry {0, 1, 0, 0} {
  Duplicata {  Line{3,4,9,10,103,113}; }
};
line_ids_4[] = Symmetry {0, 1, 0, 0} {
  Duplicata {  Line{61,62,63,64,65,66,131,132}; }
};
line_ids_5[] = Symmetry {0, 1, 0, 0} {
  Duplicata {  Line{104,105,106,107,114,115,116,117}; }
};
surf_ids_1[] = Symmetry {0, 1, 0, 0} {
  Duplicata {  Surface{11,12,13,14,15,16,61,62,63,64,65,66}; }
};
surf_ids_2[] = Symmetry {0, 1, 0, 0} {
  Duplicata {  Surface{101,102,103,111,112,113,114}; }
};
vol_ids[] = Symmetry {0, 1, 0, 0} {
  Duplicata {  Volume{1:6}; }
};
...
Transfinite Line{line_ids_1[]} = 5;
Transfinite Line{line_ids_2[]} = 19;
Transfinite Line{line_ids_3[]} = 11;
Transfinite Line{line_ids_4[]} = 11;
Transfinite Line{line_ids_5[]} = 3;

Transfinite Surface{surf_ids_1[],11,12,13,14,15,16,51,52,53,54,55,56,61,62,63,64,65,66};
Transfinite Surface{surf_ids_2[],101,102,103,111,112,113,114};
Mesh.RecombineAll = 1;

Transfinite Volume{1,2,3,4,5,6,vol_ids[]};

//// PHYSICAL GROUPS

Physical Volume(101) = {1,2,3,4,5,6}; // volume
Physical Volume(102) = {vol_ids[]}; // Other half of wing volume
Physical Surface(111) = {surf_ids_1[],11,12,13,14,15,16,61,62,63,64,65,66}; // wing
